...
const primaryGreen = '#257951'; // Màu xanh lá cây được sử dụng trong biểu đồ và icon
...
// Component phụ trợ cho Thẻ Kết quả (Được di chuyển ra ngoài hàm chính)
const ResultCard = ({ title, value, unit, icon: Icon, color }) => (
  <Box 
    sx={{ 
      ...
      // Loại bỏ boxShadow để giống với ảnh gốc
    }}
  >
    <Stack direction="row" alignItems="center" spacing={0.5} sx={{ mb: 1 }}>
      {/* Icon ArrowOutwardIcon cần được xoay 45 độ để giống ảnh */}
...
const ProgressChart = () => {
  // Hàm hiển thị nhãn trục X (chỉ hiển thị nhãn có giá trị)
  ...
  return (
    <Container 
      maxWidth="sm" // Đặt giới hạn chiều rộng
      sx={{ 
        padding: 3, 
        margin: '0 auto',
        // Chỉ nên sử dụng Box/Container cho bố cục chính, không đặt fontFamily ở đây.
      }}
    >
      {/* 1. TIÊU ĐỀ CHÍNH */}
      <Typography 
      ...
      <Box 
        sx={{ 
          height: 300, 
          mb: 3, 
          border: '1px solid #e0e0e0', // Thêm border nhẹ cho khu vực biểu đồ
          borderRadius: '4px',
          p: 1 // Padding nhẹ để biểu đồ không dính sát viền
        }}
      >
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Line
              ...
              activeDot={{ r: 8 }}
              // Đường cong biểu đồ trong ảnh gốc mượt mà hơn
              curve="monotone" 
            />
          </LineChart>
        </ResponsiveContainer>
      ...
      <Grid container spacing={2} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} sm={6}>
          <ResultCard 
            ...
            value="42:31" 
            unit="minutes" 
            icon={FiberManualRecordIcon} // Sử dụng FiberManualRecordIcon làm dấu chấm tròn
            color={primaryGreen}
          />
        </Grid>
      </Grid>
